...
var Impress = function (_Component) {
  ...
  function Impress(props) {
    ...
    var _props$rootData = props.rootData,
      rootData = _props$rootData === undefined ? {} : _props$rootData,
      _props$hint = props.hint,
      hint = _props$hint === undefined ? true : _props$hint,
      _props$hintMessage = props.hintMessage,
      hintMessage = _props$hintMessage === undefined ? _react2.default.createElement(
        'p',
        null,
        'Use ',
      ...
      _props$fallbackMessag = props.fallbackMessage,
      fallbackMessage = _props$fallbackMessag === undefined ? _react2.default.createElement(
        'p',
        null,
        'Your browser ',
        _react2.default.createElement(
      ...
      ) : _props$fallbackMessag,
      _props$progress = props.progress,
      progress = _props$progress === undefined ? false : _props$progress;
  ...
  _createClass(Impress, [{
    ...
    value: function componentDidMount() {
      ...
      if (impressSupported) this.goto(_activeStep, 0);
      ...
      window.addEventListener("hashchange", (0, _util.throttle)(function () {
        if (window.location.hash !== _lastHash) {
          let newId = window.location.hash.match(/^#\/?([^?]*)/)[1];
          let oldId = _lastHash.match(/^#\/?([^?]*)/)[1];
          if (newId !== oldId) {
            _this2.goto((0, _util.getElementFromHash)(_stepsData), 250);
          }
        }
      }, 0), false);
    }
    ...
    value: function init() {
      ...
      var _state = this.state,
        windowScale = _state.windowScale,
        config = _state.config,
        impressSupported = _state.impressSupported;
    ...
    value: function goto(step) {
      ...
      const stuff = window.location.hash.match(/^#\/?([^?]*)(.*)/)[2];
      window.location.hash = _lastHash = "#/" + step.id + stuff;
    }
    ...
    value: function render() {
      var _state3 = this.state,
        impressSupported = _state3.impressSupported,
        rootStyles = _state3.rootStyles,
        cameraStyles = _state3.cameraStyles,
        activeStep = _state3.activeStep,
        hint = _state3.hint,
        hintMessage = _state3.hintMessage,
        fallbackMessage = _state3.fallbackMessage,
